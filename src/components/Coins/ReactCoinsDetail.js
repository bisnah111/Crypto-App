          ...
          <Content style={contentStyle}>
            {
              loading
                ...
                : <React.Fragment>
                  ...
                  <Typography.Title level={3} style={{ marginTop: '3rem' }}> Prices Chart </Typography.Title>
                  <Paragraph>Prices in USD for the past 7 days. Local Standard Timezone followed.</Paragraph>
                  <Line data={chartPricesData} options={chartOptions}/>

                  <br></br>

                  <Typography.Title level={3} style={{ marginTop: '3rem' }}> Market Caps Chart </Typography.Title>
                  <Paragraph>Market cap data from the past 7 days. Local Standard Timezone followed.</Paragraph>
                  <Line data={chartMarketCapsData} options={chartOptions}/>

                  <br></br>

                  <Typography.Title level={3} style={{ marginTop: '3rem' }}> Total Volumes Chart </Typography.Title>
                  <Paragraph>Total Volumes data from the past 7 days. Local Standard Timezone followed.</Paragraph>
